export const userReturnArray = ["ID", "USERNAME", "FIRSTNAME", "LASTNAME", "USERMETADATA", "BIO", "CREATEDAT", "MODIFIEDAT", "NUMLOGINS"];
...
export const hashtagsReturnArray = ["ID", "POSTID", "HASHTAG", "CREATEDAT", "MODIFIEDAT"];
